module fighter
{
    ...
    export class GameContainer extends egret.DisplayObjectContainer
    {
        ...
        private myBulletsBonus: fighter.Bullet[] = [];
        private mybonus: fighter.Bonus[] = [];
        private bonusTimer: egret.Timer = new egret.Timer(5000);
        /**存在的Bonus */
        /**敌人的飞机*/
        ...
        private createBonusHandler(evt: egret.Event):void{
        ...
        private createBulletHandler(evt:egret.Event):void{
            ...
            if(evt.target==this.myFighter) {
                var bulletBonus: fighter.Bullet;
        ...
        private gameViewUpdate(evt:egret.Event):void{
            ...
            var k:number = 0;
            var bonus: fighter.Bonus;
            var bonuscount: number = this.mybonus.length;
            ...
            var j:number = 0;
            var bulletBonus:fighter.Bullet;
            var myBulletsBonusCount:number = this.myBulletsBonus.length;
